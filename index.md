...
humandate: "Feb. 21st, 28th & March 6th, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "1:00pm - 4:00pm (Atlantic)"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2024-02-21      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2024-03-06        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Ryan Gosse"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Tannia Chevez", "Ross Dickson", "Akshay Ghosh", "Brian Jones", "Shannon Landovskis", "Ying Niu", "Sarah Popov", "Jon Pye", "Naomi Tress", "Serguei Vassiliev"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
eventbrite: "806575949377" # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
